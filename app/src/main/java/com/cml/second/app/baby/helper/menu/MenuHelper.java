...
import com.cml.second.app.baby.fragment.CustomRecycerviewFragment;
import com.cml.second.app.baby.fragment.CustomRecyclerViewAnimator;
...
import com.cml.second.app.baby.fragment.NestScrollingFragment;
...
//                ContainerActivity.startActivity(menuActivity, BottomSheetFragment.class);
            ...
            case 9:
                ...
                break;
            case 10:
                ContainerActivity.startActivity(menuActivity, NestScrollingFragment.class);//nestScrolling
                break;
            case 11:
            ...
            case 16:
                ...
                break;
            case 17:
                ContainerActivity.startActivity(menuActivity, CustomRecycerviewFragment.class);
                break;
            case 18:
                ContainerActivity.startActivity(menuActivity, CustomRecyclerViewAnimator.class);
                break;
        }
        drawer.closeDrawer(GravityCompat.START);
        if (null != item) {
