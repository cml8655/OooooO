        ...
        if (holder != null) {
            if (i == 0) {
                ...
                if (mFolders.size() > 0) {
                    ...
                    Glide.with(mContext).load(new File(f.cover.path)).error(R.drawable.default_error).override(R.dimen.folder_cover_size, R.dimen.folder_cover_size).centerCrop().into(holder.cover);
...
//                            .into(holder.cover);
    ...
    class ViewHolder {
        ...
        void bindData(Folder data) {
            ...
            // 显示图片
            if (data.cover != null) {
                Glide.with(mContext).load(new File(data.cover.path)).error(R.drawable.default_error).centerCrop().override(R.dimen.folder_cover_size, R.dimen.folder_cover_size).into(cover);
//                Picasso.with(mContext)
